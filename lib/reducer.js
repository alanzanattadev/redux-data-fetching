...
import { graphQLizr, convertsNormalizedEntitiesToRecords } from './graphqlTypesConverters';
import _ from 'lodash';

export default function configureReducer(normalizrTypes, recordsTypes, graphQLSchema) {
      ...
      case 'DATA_RECEIVED':
        ...
        return state
          .update('entities', entities =>
            entities.mergeDeepWith((a, b) => b === undefined ? a : b, convertsNormalizedEntitiesToRecords(normalized.entities, recordsTypes, graphQLSchema)))
